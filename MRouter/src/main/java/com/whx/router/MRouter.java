...
import com.whx.router.core.ApplicationModuleCenter;
import com.whx.router.core.EventCenter;
import com.whx.router.core.InterceptorCenter;
import com.whx.router.core.InterceptorServiceImpl;
import com.whx.router.core.RouteCenter;
import com.whx.router.core.RouteModuleCenter;
import com.whx.router.core.ServiceCenter;
import com.whx.router.core.interfaces.IInterceptorService;
import com.whx.router.enums.RouteType;
...
import com.whx.router.logger.DefaultLogger;
import com.whx.router.logger.ILogger;
import com.whx.router.model.Card;
import com.whx.router.module.interfaces.IRouteModuleGroup;
import com.whx.router.thread.DefaultPoolExecutor;
...
public final class MRouter {
    ...
    private static class InstanceHolder {
        private static final MRouter mInstance = new MRouter();
    }
    ...
    public static synchronized void autoLoadRouteModule(Application application) {
        ...
        logger.info(null, "[MRouter] autoLoadRouteModule!");
