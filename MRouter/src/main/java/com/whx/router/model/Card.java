...
public final class Card extends CardMeta {
    ...
    private Object go(Context context, Card card, int requestCode, ActivityResultLauncher<Intent> activityResultLauncher, GoCallback callback) {
        return MRouter.getInstance().go(context, card, requestCode, activityResultLauncher, callback);
    }
    ...
    public CardMeta getCardMeta() {
        try {
            ...
            MRouter.logger.warning(null, e.getMessage());
        }
        return null;
    }
    ...
    public void setContext(Context context) {
        if (context == null) {
            throw new RouterException("Context cannot be empty, Call 'MRouter.setApplication(...)' in application.");
        }
