...
import com.whx.router.plugin.model.ParamModel
import com.whx.router.plugin.model.RouteHelperModel
import com.whx.router.plugin.model.RouteModel
import com.whx.router.plugin.utils.Constants
import com.whx.router.plugin.utils.Constants.CARD_CLSS_NAME
import com.whx.router.plugin.utils.Constants.CARD_META_CLSS_NAME
import com.whx.router.plugin.utils.Constants.CONTEXT
import com.whx.router.plugin.utils.Constants.FIELD_CARD
import com.whx.router.plugin.utils.Constants.FRAGMENT
import com.whx.router.plugin.utils.Constants.GOROUTER_CLASS_NAME
import com.whx.router.plugin.utils.Constants.GOROUTER_HELPER_PACKAGE_NAME
import com.whx.router.plugin.utils.Constants.I_DEGRADE_SERVICE
import com.whx.router.plugin.utils.Constants.I_JSON_SERVICE
import com.whx.router.plugin.utils.Constants.I_PRETREATMENT_SERVICE
import com.whx.router.plugin.utils.Constants.PROJECT
import com.whx.router.plugin.utils.Constants.WARNING_TIPS
...
class AssembleGoRouteHelperCode(private val model: RouteHelperModel) {
    ...
    private val MRouter = ClassName.bestGuess(GOROUTER_CLASS_NAME)
