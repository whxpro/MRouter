...
object Constants {
    ...
    const val PACKAGE_NAME = "com.whx.router"
     ...
     * GoRouterHelper
     */
    const val WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY MROUTER."
    const val GOROUTER_CLASS_NAME = "$PACKAGE_NAME.MRouter"
    const val GOROUTER_HELPER_PACKAGE_NAME = "$PACKAGE_NAME.helper"
    ...
    const val CARD_CLSS_NAME = "${PACKAGE_NAME}.model.Card"
    const val CARD_META_CLSS_NAME = "${PACKAGE_NAME}.model.CardMeta"
