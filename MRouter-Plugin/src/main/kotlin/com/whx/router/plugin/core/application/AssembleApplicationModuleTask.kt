package com.whx.router.plugin.core.application

import com.whx.router.plugin.utils.Constants
import com.whx.router.plugin.utils.Constants.APPLICATION_MODULE_NAME_SUFFIX
import com.whx.router.plugin.utils.Constants.APPLICATION_MODULE_INJECT_CLASS_NAME
import com.whx.router.plugin.utils.Constants.APPLICATION_MODULE_SCAN_TARGET_INJECT_PACKAGE_NAME
...
//            Logger.i("Scan to jar [${file.asFile.absolutePath}]")
    ...
    private fun injectCode() {
        val resultByteArray = com.whx.router.plugin.core.application.AssembleApplicationModuleCodeInjector(
            applicationModuleClassList
