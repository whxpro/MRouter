package com.whx.router.plugin.core.doc

import com.android.build.api.variant.Variant
import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.whx.router.plugin.model.DocumentModel
...
abstract class GenerateRouteDocTask : DefaultTask() {
    ...
    @TaskAction
    fun taskAction() {
        Logger.i(TAG, "Generate MRouter document task start.")
        ...
        Logger.i(TAG, "Generate MRouter document[${documentName}] task end. $docOutFilePath")
    }
